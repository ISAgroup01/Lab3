...
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/rst
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/alu_opcode
add wave -noupdate -group CU -radix hexadecimal /tb_riscv/risc_v/dp_cu/ir_in
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/ir_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/npc_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/reg1_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/reg2_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/pc_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/regimm_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/regd_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/mux_sel
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/add_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/alu_outreg_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/reg_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/eq_cond
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/regd1_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/mem_we
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/data_mem_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/bypass_mem_latch_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/jump_en
add wave -noupdate -group CU -group {enable signals} /tb_riscv/risc_v/dp_cu/regd2_latch_en
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/wb_mux_sel1
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/wb_mux_sel2
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/rf_we
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/ir_opcode
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/ir_func
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw_mem
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw1
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw2
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw3
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw4
add wave -noupdate -group CU -group cw /tb_riscv/risc_v/dp_cu/cw5
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/aluopcode_i
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/aluopcode1
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/aluopcode2
add wave -noupdate -group CU /tb_riscv/risc_v/dp_cu/aluopcode3
